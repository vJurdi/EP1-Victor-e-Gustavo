# -*- coding: utf-8 -*-
"""
Created on Tue Sep 18 14:26:25 2018
...
firebase = firebase.FirebaseApplication('https://ep1-victor-e-gustavo.firebaseio.com/',None)
if firebase.get('/',None) is None:
    cardapio_comandas = {}
else:
    cardapio_comandas = firebase.get('/',None)
    
    
cardapio=cardapio_comandas['cardapio']

comandas=cardapio_comandas['comandas']
...
firebase.patch('https://ep1-victor-e-gustavo.firebaseio.com/', cardapio_comandas)  
